...
public class test {
	...
	public static void main(String[] args) {
		...
		professor1.name = "Ahmet Aslan";
		
		Course course1 = new Course();
		course1.name = "Software Engineering";
		
		Student student1 = new Student();
		student1.name = "Nevzat MAMAC";
		...
		professor1.coursesGiven = new Course[100];
		...
		System.out.println("Name of Student stundent1's first course's prof is " + student1.coursesTaken[0].teacher.name);
		System.out.println("Name of student student1's firs course's prof's department is " + student1.coursesTaken[0].teacher.department.name);
